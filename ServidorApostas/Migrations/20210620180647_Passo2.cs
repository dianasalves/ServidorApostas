...
{
    public partial class Passo2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //    constraints: table =>
            //    {
            //        table.PrimaryKey("PK_MUtilizador", x => x.id);
            //    });
            ...
            //    constraints: table =>
            //    {
            //        table.PrimaryKey("PK_MApostas", x => x.id);
            //        table.ForeignKey(
            //            name: "FK_MApostas_MUtilizador_utilizadorid",
            //            column: x => x.utilizadorid,
            //            principalTable: "MUtilizador",
            //            principalColumn: "id",
            //            onDelete: ReferentialAction.Cascade);
            //    });

            //migrationBuilder.CreateIndex(
            //    name: "IX_MApostas_utilizadorid",
            //    table: "MApostas",
            //    column: "utilizadorid");
        }
